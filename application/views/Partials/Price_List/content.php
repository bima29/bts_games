            ...
            <div class="container border border-light rounded p-5 w-100 bg-color-blur-black-6">
                <form class="d-flex w-100" method="GET" action="">
                    <div class="input-group w-100">
                        ...
                        <input class="form-control text-white bg-color-blur-black-7 custom-input" type="text" name="search" placeholder="Ketik nama game..." aria-label="Order Number" style="font-size: 1.2rem; padding: 0.75rem; border-right: none;" value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                                ...
                                <?php foreach ($filteredPrices as $price) : ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-center">
                                            <a href="<?= base_url('Home/Checkout1/' . $price['id']); ?>" class="btn btn-primary rounded-pill btn-sm">Top Up</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
