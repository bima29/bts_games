            ...
            <div class="payment-method-wrapper">
                <div class="row no-gutters">
                    ...
                    <div class="col-12 col-md-4 px-2 mb-3">
                        <a href="<?= base_url('Home/Checkout3/' . $price_id . '/4500'); ?>" class="text-decoration-none">
                    ...
                    <!-- QRIS -->
                    <div class="col-12 col-md-4 px-2 mb-3">
                        <a href="<?= base_url('Home/Checkout3/' . $price_id . '/' . ($price->price * 0.005)); ?>" class="text-decoration-none">
                            <div class="payment-card p-3 border rounded d-flex flex-column align-items-center text-center bg-white shadow-sm h-100">
                    ...
                    <!-- Gopay -->
                    <div class="col-12 col-md-4 px-2 mb-3">
                        <a href="<?= base_url('Home/Checkout3/' . $price_id . '/' . ($price->price * 0.025)); ?>" class="text-decoration-none">
                            <div class="payment-card p-3 border rounded d-flex flex-column align-items-center text-center bg-white shadow-sm h-100">
