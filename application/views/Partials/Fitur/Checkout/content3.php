<link rel="stylesheet" href="<?= base_url('assets/css/content3.css') ?>">
...
<div class="container-fluid d-flex  mb-4 bg-color-blur-white-4">
    <div class="row w-100 justify-content-center align-items-center">
        <div class="col-md-4 justify-content-center  mt-4">
            <div class="checkout-container mt-4 mb-5 container-sm cc-size">
                <a href="<?= base_url('Home/Checkout2'); ?>">
                ...
                <form>
                    <div class="mb-4">
                        ...
                        <div class="dropdown w-100 mt-2">
                            <button class="btn dropdown-toggle w-100 d-flex justify-content-between" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                Transfer Bank
                            </button>
                            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/bri-0dd9.png" alt="BRI" class="me-2" width="20">
                                        BRI</a></li>
                                <hr>
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/bca-5e57.png" alt="BCA" class="me-2" width="20">
                                        BCA</a></li>
                            </ul>
                        </div>
                        <hr>
                        ...
                        <div class="dropdown w-100 mt-2">
                            <button class="btn dropdown-toggle w-100 d-flex justify-content-between" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                                QRIS
                            </button>
                            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton2">
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/qris%20gsi-min-5c51.png" alt="QRIS" class="me-2" width="20">
                                        QRIS</a></li>
                            </ul>
                        </div>
                        <hr>
                        ...
                        <div class="dropdown w-100 mt-2">
                            <button class="btn dropdown-toggle w-100 d-flex justify-content-between" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                E-Wallet
                            </button>
                            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton3">
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/dana-418f.png" alt="DANA" class="me-2" width="20">
                                        DANA</a></li>
                                <hr>
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/ovo-6d34.png" alt="OVO" class="me-2" width="20">
                                        OVO</a></li>
                                <hr>
                                <li><a class="dropdown-item" href="#">
                                        <img src="https://static-src.vocagame.com/gamestoreindonesia/spay-e7b10-original.webp" alt="ShopeePay" class="me-2" width="20">
                                        Shopee Pay</a></li>
                                <hr>
                            </ul>
                        </div>
                    ...
                    <a href="<?= base_url('Home/index'); ?>" class="btn btn-primary w-100">Selesaikan Pesanan</a>
                </form>
            </div>
...
<script src="<?= base_url('assets/js/content3.js') ?>"></script>
