            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('track_order.php') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('price_list.php') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('live_chat.php') ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview" style="background-color: #2c3e50; padding-left: 15px;">
                                <li class="nav-item">
                                    <a href="<?= base_url('game_categories.php') ?>" class="nav-link" style="padding-left: 30px;">
                                        <i class="nav-icon fas fa-tags"></i>
                                        <p>Game Categories</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('game_list.php') ?>" class="nav-link" style="padding-left: 30px;">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('banner.php') ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview" style="background-color: #2c3e50; padding-left: 15px;">
                                <li class="nav-item">
                                    <a href="<?= base_url('duitku.php') ?>" class="nav-link" style="padding-left: 30px;">
                                        <i class="nav-icon fas fa-wallet"></i>
                                        <p>Duitku</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('digiflazz.php') ?>" class="nav-link" style="padding-left: 30px;">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview" style="background-color: #2c3e50; padding-left: 15px;">
                                <li class="nav-item">
                                    <a href="<?= base_url('account_role.php') ?>" class="nav-link" style="padding-left: 30px;">
                                        <i class="nav-icon fas fa-id-badge"></i>
                                        <p>Account Role</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('manage_account.php') ?>" class="nav-link" style="padding-left: 30px;">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('logout.php') ?>" class="nav-link" style="padding: 0;">
